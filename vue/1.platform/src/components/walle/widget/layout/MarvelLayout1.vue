...
<script>
  /**
   *  MarvelLayout1 widget description
   *  @vuedoc
   *  @exports MarvelLayout1
   */
  export default {
    name: 'MarvelLayout1',
    props: {
