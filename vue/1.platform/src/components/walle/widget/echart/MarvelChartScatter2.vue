...
<script>
  ...
  /**
   *  MarvelChartScatter2 widget description
   *  @vuedoc
   *  @exports MarvelChartScatter2
   */
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        ...
        this.chartObj.on("click", function (params) {
          if (params.componentType == "series" &&
            ...
            self.callback4OnClick(params.data);
          }
        });
      },
      _destroy: function () {
      ...
      callback4OnClick: function (oData) {
        this.$emit("onClick", oData);
      },
