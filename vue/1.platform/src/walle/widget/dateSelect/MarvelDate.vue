  ...
  <div class="datepickerWrapper icon-marvelIcon-21"
    ...
    <transition name="datepicker-anim">
      <div class="datepicker-popup" :class="[popupClass,{'datepicker-inline':type==='inline'}]" tabindex="-1"
        ...
        <template v-if="range">
          <marvel-date-calendar v-model="dates[0]" :left="true"></marvel-date-calendar>
          <marvel-date-calendar v-model="dates[1]" :right="true"></marvel-date-calendar>
        </template>
        <template v-else>
          <marvel-date-calendar v-model="dates[0]"></marvel-date-calendar>
        </template>
      </div>
    </transition>
  </div>
...
<script>
  import MarvelDateCalendar from "./MarvelDateCalendar";

  /**
   *  MarvelDateC widget description
   *  @vuedoc
   *  @exports MarvelDateC
   */
  export default {
    name: 'MarvelDate',
    components: {MarvelDateCalendar},
    props: {
      name: {
        type: String,
        default: "",
