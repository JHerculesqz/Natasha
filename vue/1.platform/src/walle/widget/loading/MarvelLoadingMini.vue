    ...
    <div class="microLoading" v-show="show">
      <div class="loadingBoard">
        <div class="loadingIcon">
          <div class="icon" v-if="progress != 100">
          ...
          <div class="iconFinish icon-checkmark" v-else></div>
        </div>
        <div class="loadingTip">{{ progressMsg }}</div>
        <div class="loadingBar">
          <div class="currentRate" v-bind:style="{ width: progress + '%' }"></div>
        </div>
        <div class="loadingTip">{{ progress }}%</div>
        <div class="loadingCancel" v-if="progress != 100" v-on:click="cancelEx">{{ cancelLabel }}</div>
      </div>
    </div>
  </div>
  <!--微观loading end-->
...
<script>
  /**
   *  MarvelLoadingMini widget description
   *  @vuedoc
   *  @exports MarvelLoadingMini
   */
  export default {
