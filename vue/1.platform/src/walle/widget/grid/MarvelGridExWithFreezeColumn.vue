  ...
  <div class="GridExWithFreezeColumnWrapper" :id="gridId">
    ...
    <div class="freezeTables" :style="contentStyle" :class="contentClass">
      <div class="freezeTable freezeLeftTable"
        ...
        <marvel-grid-ex-freeze :ref="leftTableId"
                               :gridId="leftTableId"
                               :titles="leftTitles"
                               :rows="leftRows"
                               ...
                               v-on:onPageChange="onPageChange"></marvel-grid-ex-freeze>
      </div>
      <div class="freezeTable centerTable"
           v-if="bHasCenterTable"
           :style="centerTableStyle">
        <marvel-grid-ex-freeze :ref="centerTableId"
      ...
      <div class="freezeTable freezeRightTable"
        ...
        <marvel-grid-ex-freeze :ref="rightTableId"
                               :gridId="rightTableId"
                               :titles="rightTitles"
                               :rows="rightRows"
                               :limit="limit4TableItem"
    ...
    <marvel-grid-column-config ref="ref4ColumnConfig"
                               @handleTblDataToShow="_handleGridDataToShow"></marvel-grid-column-config>
  </div>
</template>
...
<script>
  ...
  /**
   *  MarvelGridExWithFreezeColumn widget description
   *  @vuedoc
   *  @exports MarvelGridExWithFreezeColumn
   */
  export default {
    components: {
      MarvelGridColumnConfig,
      MarvelGridExFreeze,
      MarvelPaging
    },
    name: 'MarvelGridExWithFreezeColumn',
    props: {
      titles: {
        type: Array,
        default: undefined,
