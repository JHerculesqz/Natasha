<template>
  <div class="widgetShowSession">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelZTreeIFrame" id="page4MarvelZTreeIFrame" src="static/jsdoc/module-MarvelZTree.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelZTreeIFrame.setIframe4DemoPage();
      },
