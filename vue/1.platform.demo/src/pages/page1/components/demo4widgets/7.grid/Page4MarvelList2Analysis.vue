<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelList2Analysis</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelList2AnalysisIFrame" id="page4MarvelList2AnalysisIFrame" src="static/jsdoc/module-MarvelList2Analysis.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelList2AnalysisIFrame.setIframe4DemoPage();
      },
