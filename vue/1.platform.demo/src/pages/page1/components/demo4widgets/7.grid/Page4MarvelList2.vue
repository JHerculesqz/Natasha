<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelList2</div>
    <div class="describe">
      ...
      <marvel-tab :tabItems="tabItems1">
        <marvel-tab-item :isActive="tabItems1[0].isActive">
          <div class="showAreaInner">
            ...
            <marvel-list2 :bargeCount="listBargeCount" title="Test" ref="test" :oStyle="oStyle"></marvel-list2>
            <!--2级DemoView end-->
          </div>
        </marvel-tab-item>
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="IFrame" id="IFrame" src="static/jsdoc/module-MarvelList2.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
