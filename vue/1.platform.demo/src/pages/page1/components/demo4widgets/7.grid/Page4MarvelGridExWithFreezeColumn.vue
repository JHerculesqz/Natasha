<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelGridExWithFreezeColumn</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelGridExWithFreezeColumnIFrame" id="page4MarvelGridExWithFreezeColumnIFrame" src="static/jsdoc/module-MarvelGridExWithFreezeColumn.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelGridExWithFreezeColumnIFrame.setIframe4DemoPage();
