<template>
  <div class="widgetShowSession">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelList4IFrame" id="page4MarvelList4IFrame" src="static/jsdoc/module-MarvelList4.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  import MarvelList4 from "^/widget/list/MarvelList4";
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelList4IFrame.setIframe4DemoPage();
      },
