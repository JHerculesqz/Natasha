<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelGridExFreeze</div>
    <div class="describe">
      界面框架
    </div>
    <!--1级 end-->
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="IFrame" id="IFrame" src="static/jsdoc/module-MarvelGridExFreeze.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
