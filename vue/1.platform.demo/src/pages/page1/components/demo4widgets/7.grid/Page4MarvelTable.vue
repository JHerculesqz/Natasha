<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelTable</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelTableIFrame" id="page4MarvelTableIFrame" src="static/jsdoc/module-MarvelTable.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
