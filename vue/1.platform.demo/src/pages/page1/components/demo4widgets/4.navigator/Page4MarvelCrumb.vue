<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelCrumb</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelCrumbIFrame" id="page4MarvelCrumbIFrame" src="static/jsdoc/module-MarvelCrumb.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelCrumbIFrame.setIframe4DemoPage();
      },
