<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelAccordion3</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelAccordion3IFrame" id="page4MarvelAccordion3IFrame" src="static/jsdoc/module-MarvelAccordion3.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelAccordion3IFrame.setIframe4DemoPage();
      },
