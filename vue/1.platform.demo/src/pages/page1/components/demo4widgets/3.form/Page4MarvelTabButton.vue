<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelTabButton</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelTabButtonIFrame" id="page4MarvelTabButtonIFrame" src="static/jsdoc/module-MarvelTabButton.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelTabButtonIFrame.setIframe4DemoPage();
      },
