<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelTxtButton</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelTxtButtonIFrame" id="page4MarvelTxtButtonIFrame" src="static/jsdoc/module-MarvelTxtButton.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelTxtButtonIFrame.setIframe4DemoPage();
      },
