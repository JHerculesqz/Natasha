<template>
  <div class="widgetShowSession">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelInfoIFrame" id="page4MarvelInfoIFrame" src="static/jsdoc/module-MarvelInfo.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelInfoIFrame.setIframe4DemoPage();
      },
