<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelSelectCard</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelSelectCardIFrame" id="page4MarvelSelectCardIFrame" src="static/jsdoc/module-MarvelSelectCard.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelSelectCardIFrame.setIframe4DemoPage();
      },
