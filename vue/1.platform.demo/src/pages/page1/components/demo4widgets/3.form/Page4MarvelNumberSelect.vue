<template>
  <div class="widgetShowSession">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelNumberSelectIFrame" id="page4MarvelNumberSelectIFrame" src="static/jsdoc/module-MarvelNumberSelect.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelNumberSelectIFrame.setIframe4DemoPage();
      },
