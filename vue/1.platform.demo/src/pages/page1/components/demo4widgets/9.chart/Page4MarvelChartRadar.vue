<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelChartRadar</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelChartRadarIFrame" id="page4MarvelChartRadarIFrame" src="static/jsdoc/module-MarvelChartRadar.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelChartRadarIFrame.setIframe4DemoPage();
