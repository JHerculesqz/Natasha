<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelChartBarLine2</div>
    <div class="describe">
        ...
        <marvel-tab-item :isActive="tabItems1[0].isActive">
          <div class="showAreaInner">
            ...
            <div style="width: 1200px; height: 350px">
              <marvel-chart-bar-line2 ref="ref4FirstHistogram"
                                     id="isFirstHistogram"
                                     v-on:onItemClick="onItemClick"></marvel-chart-bar-line2>
            </div>
            <!--2级DemoView end-->
          </div>
        </marvel-tab-item>
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="IFrame" id="IFrame" src="static/jsdoc/module-MarvelChartBarLine2.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  import MarvelChartBarLine2 from "~~/widget/echart/MarvelChartBarLine2";
