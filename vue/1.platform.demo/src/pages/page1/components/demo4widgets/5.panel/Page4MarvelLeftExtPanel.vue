<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelLeftExtPanel</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelLeftExtPanelIFrame" id="page4MarvelLeftExtPanelIFrame" src="static/jsdoc/module-MarvelLeftExtPanel.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelLeftExtPanelIFrame.setIframe4DemoPage();
      },
