<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelDialog</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelDialogIFrame" id="page4MarvelDialogIFrame" src="static/jsdoc/module-MarvelDialog.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelDialogIFrame.setIframe4DemoPage();
      },
