<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelLayout1</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelLayout1page4MarvelLayout1IFrame" id="page4MarvelLayout1page4MarvelLayout1IFrame" src="static/jsdoc/module-MarvelLayout1.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelLayout1IFrame.setIframe4DemoPage();
      },
