<template>
  <div class="widgetShowSession">
    <!--1级 start-->
    <div class="title level1">MarvelWarning</div>
    <div class="describe">
    ...
    <!--region doc area-->
    <div class="docArea">
      <marvel-i-frame ref="page4MarvelWarningIFrame" id="page4MarvelWarningIFrame" src="static/jsdoc/module-MarvelWarning.html"></marvel-i-frame>
    </div>
    <!--endregion-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _initEx: function () {
        this.$refs.page4MarvelWarningIFrame.setIframe4DemoPage();
      },
